/datum/map/forest
	...
	station_name  = "Forgotten World"
	station_short = "Forgotten World"
	dock_name     = "TBD"
	boss_name     = "Central Utopia Command"
	boss_short    = "CentUtopiacomm"
	company_name  = "Utopia"
	company_short = "UT"

	map_admin_faxes = list("Utopia Central Office")
