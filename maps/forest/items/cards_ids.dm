...
/obj/item/card/id/sierra
	...
	desc = "An identification card issued to personnel aboard the Sierra."
...
/obj/item/card/id/sierra/passenger
	desc = "An identification card issued to passengers aboard the Sierra."
	job_access_type = /datum/job/assistant
	color = "#ccecff"

/obj/item/card/id/sierra/crew
	desc = "An identification card issued to NanoTrasen crewmembers aboard the Sierra."
	job_access_type = /datum/job/assistant
	color = "#ccecff"

/obj/item/card/id/sierra/crew/medical
	desc = "An identification card issued to NanoTrasen medical members aboard the Sierra."
...
/obj/item/card/id/sierra/crew/security
	desc = "An identification card issued to judge's personnel aboard the Sierra."
