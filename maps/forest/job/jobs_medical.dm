/datum/job/senior_doctor
	...
	economic_power = 8
	alt_titles = list(
		"НЕ БРАТЬ" = /decl/hierarchy/outfit/job/sierra/crew/medical/senior/xenosurgeon,
		"НЕ БРАТЬ" = /decl/hierarchy/outfit/job/sierra/crew/medical/senior/traumasurgeon
	)
...
/datum/job/doctor
	...
	alt_titles = list(
		"НЕ БРАТЬ" = /decl/hierarchy/outfit/job/sierra/crew/medical/doctor/paramedic
	)
...
/datum/job/doctor_trainee
	...
	alt_titles = list(
		"НЕ БРАТЬ" = /decl/hierarchy/outfit/job/sierra/crew/medical/doctor/orderly,
		"НЕ БРАТЬ" = /decl/hierarchy/outfit/job/sierra/crew/medical/doctor/nurse
	)
	outfit_type = /decl/hierarchy/outfit/job/sierra/crew/medical/doctor
	allowed_branches = list(
...
/datum/job/psychiatrist/equip(var/mob/living/carbon/human/H)
	if(H.mind.role_alt_title == "НЕ БРАТЬ")
