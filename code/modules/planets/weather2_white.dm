...
/datum/weather
	/// name of weather
	var/name = "Космический ветер"
	/// description of weather
	var/desc = "Космический мощный ветер, уничтожающий всё живое на своём пути.."
	/// The message displayed in chat to foreshadow the weather's beginning
	var/telegraph_message = "<span class='warning'>Наблюдается резкое повышение скорости порывов ветра. Рекомендуется найти укрытие до снижения.</span>"
	...
	var/weather_message = "<span class='userdanger'>Скорость ветра резко повышается. Вы чувствуете, как против него становится всё тяжелее идти, а в конечном итоге и вовсе невозможно.</span>"
	...
	var/end_message = "<span class='danger'>Скорость ветра снижается, в округе теперь спокойнее.</span>"
