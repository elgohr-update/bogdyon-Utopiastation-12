...
/obj/item/gun/projectile/shotgun/stalker/bm16  // Ãîðèçîíòàëêà
	name = "БМ-16"
	desc = "Какое-то ржавое охотничье ружьё. Если повезёт, что выстрелит, убьёте. И то лишь в упор."
	...
	recoil = 1
	durability = 150
	sawn_desc = "Популярный и ржавый обрез какого-то охотничьего ружья. Если повезёт, что выстрелит, убьёте. И то лишь в упор."
	randomspread = 0
	spread = 12
	damagelose = 0.3
	distro = 25
...
/obj/item/gun/projectile/shotgun/stalker/bm16/toz34  //  Âåðòèêàëêà
	name = "ТОЗ-34"
	desc = "Какое-то ржавое охотничье ружьё. Если повезёт, что выстрелит, убьёте. И то лишь в упор. Имеет хорошее останавливающее действие."
...
/obj/item/gun/projectile/shotgun/stalker/bm16/sawnoff
	name = "Обрез БМ-16"
	desc = "Çíà÷èòåëüíî êîìïàêòíåé è ëåã÷å íîâîé äâóñòâîëêè, íî ýôôåêòèâåí òîëüêî â áëèæíåì áîþ. Îäèí èç ñàìûõ ðàñïðîñòðàí¸ííûõ âèäîâ îðóæè&#255; ó íîâè÷êîâ."
...
/obj/item/gun/projectile/shotgun/stalker/metro/douplet
	name = "Doublet"
	desc = "Ñîáðàííûé ìåñòíûìè 'ìàñòåðàìè' äâóõñòâîëüíûé äðîáîâèê. Íàèìåíîâàí òàêèì ñëîâîì êàê 'Äóïëåò'."
...
/obj/item/gun/projectile/shotgun/stalker/metro/ashot
	name = "Ashot"
	desc = "Íåñìîòð&#255; íà ïðèìèòèâíîñòü êîíñòðóêöèè, ýòîò ìàññîâî ïðîèçâîä&#255;ùèéñ&#255; â Ìåòðî êàðòå÷íûé ïèñòîëåò &#255;âë&#255;åòñ&#255; ìîùíûì è íàä¸æíûì îðóæèåì áëèæíåãî áî&#255;."
