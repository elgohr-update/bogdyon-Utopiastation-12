...
/sidoritem/vintorez
    name = "Vintar VS"
    itemtype = /obj/item/gun/projectile/stalker/svd
    cost = 27000
    words = list("винторез" = 5, "винтарь" = 5, "vintar" = 10)

/sidoritem/val
    name = "Specgun VLA"
    itemtype = /obj/item/gun/projectile/stalker/vsv
    cost = 23000
